...
import static libot.commands.utilities.PollCommand.Poll.createPoll;
import static libot.core.Constants.*;
import static libot.core.commands.CommandCategory.UTILITIES;
import static libot.utils.DiscordUtils.sendUsage;
...
import libot.commands.utilities.PollCommand.Poll.PollException;
...
import libot.core.data.providers.impl.PollProvider;
...
public class PollCommand extends Command {
	...
	private void managePolls(@Nonnull CommandContext c, @Nonnull PollProvider prov) {
		...
		switch (mode) {
			case SWITCH_HELP -> sendUsage(c, this);
